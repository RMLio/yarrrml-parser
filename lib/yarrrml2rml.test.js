...
describe('expanded test', function () {
  ...
  it('works for example1', function (done) {
    work('example1/mapping.yml', 'example1/mapping.rml.ttl', done);
  });
  ...
  it('works for example4', function (done) {
    work('example4/mapping.yml', 'example4/mapping.rml.ttl', done);
  });

  it.skip('works for example5', function (done) {
    work('example5/mapping.yml', 'example5/mapping.rml.ttl', done);
  });
  ...
  it('condition on po', function (done) {
    work('condition-on-po/mapping.yml', 'condition-on-po/mapping.rml.ttl', done);
  });

  it('condition on mapping with IRI as subject', function (done) {
    work('condition-on-mapping/mapping.yml', 'condition-on-mapping/mapping.rml.ttl', done);
  });
  ...
  it('function shortcut', function (done) {
    work('function-shortcut/mapping.yml', 'function-shortcut/mapping.rml.ttl', done);
  });
