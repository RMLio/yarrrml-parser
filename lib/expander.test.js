...
describe('expander', () => {
  ...
  describe('changeDetection', () => {
    ...
    describe('mappingRemove', () => {
      ...
      it('remove key with empty value from mapping', () => {
        const input = {
          prefixes: {ex: "http://example.com/"},
          sources: {
            'source-create': {
      ...
      it('remove all predicateobjects', () => {
        const input = {
          mappings: {
            sensors: {
              sources: [['base.json~jsonpath', '$.*']],
      ...
      it('remove all subject mappings', () => {
        const input = {
          prefixes: {ex: "http://example.com/"},
          sources: {
            'source-create': {
    ...
    describe('subject function expansion', () => {
      ...
      it('implicit delete without mappingAdd: removes all POs except the `rdf:type` ones.', () => {
        ...
        const input = {
          mappings: {
            sensors: {
              ...
              subjects: ["ex:sensor/$(sensor)"],
              changeDetection: {
                delete: { explicit: false }
              },
              predicateobjects: [
                ["ex:pressure", "$(pressure)"],
                {
                  predicates: ["a"],
                  objects: ["ex:Sensor", "ex:MobileDevice"]
                }
              ]
            }
          }
        ...
        const expectedOutput = {
          mappings: {
            'sensors-delete': {
              ...
              subjects: [{
                function: "https://w3id.org/imec/idlab/function#implicitDelete",
                parameters: [
                  {
                    from: "subject",
                    parameter: "https://w3id.org/imec/idlab/function#iri",
      ...
      it('implicit delete without mappingAdd: removes all POs.', () => {
      ...
      it('implicit delete with mappingAdd: removes all POs.', () => {
              ...
              changeDetection: {
                ...
                delete: {
                  ...
                  mappingAdd: {
                    ...
                    po: [['ex:currentState', 'ex:deleted~iri']]
                  }
                }
              },
              predicateobjects: [["ex:pressure", "$(pressure)"]]
