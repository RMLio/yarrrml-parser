  ...
  if (document.targets) {
    ...
    for (let i = 0; i < targetKeys.length; i++) {
      ...
      if (target.sources) {
        ...
        const dynamic_template_var = t = target.access.replace(/(.*)\$\(([^)]*)\)(.*)/g, "$2"); // blabla$(var)blab -> var
        ...
        const dynamic_target_key = 'generated_lt_' + targetName + '_$(' + dynamic_template_var + ')_' + lt_id_str;
