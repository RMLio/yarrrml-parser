...
function getId(prediacteOrObjectMapping) {
  // an object mapping gets identified by a `value` or a `function` or ....
  let id;
  if (typeof prediacteOrObjectMapping === 'string') {
    id = prediacteOrObjectMapping;
  } else if (Object.hasOwn(prediacteOrObjectMapping, 'value')) {
    id = prediacteOrObjectMapping.value;
  } else if (Object.hasOwn(prediacteOrObjectMapping, 'function')) {
    id = prediacteOrObjectMapping.function;
  }
  return id;
}
