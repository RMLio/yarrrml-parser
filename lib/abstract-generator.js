...
class AbstractGenerator {
  ...
  _combineExpandedJSONs(expandedJSONs) {
    const result = {mappings: {}, prefixes: {}, sources: {}, targets: {}, authentications: {}};
    ...
    for (const json of expandedJSONs) {
      ...
      this._addSourceValuesToTarget(json.authentications, result.authentications, 'Authentication');
  ...
  generateMapping(tmSubject, mapping, mappingName, sourceSubject, targetsIRIMap) {
    ...
    mapping.subjects.forEach(subject => {
      ...
      this.addLogicalTargetMapsTemplateIfAppropriate(subject, smSubject);
    ...
    if (mapping.predicateobjects) {
      mapping.predicateobjects.forEach(po => {
        ...
        po.predicates.forEach(p => {
          ...
          this.addLogicalTargetMapsTemplateIfAppropriate(p, pmSubject);
        ...
        po.objects.forEach(o => {
          if (o.mapping) {
            ...
            this.addLogicalTargetMapsTemplateIfAppropriate(o, omSubject);
