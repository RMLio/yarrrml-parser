...
describe('YARRRML to RML', function () {
  ...
  describe('IncRML-LDES', () => {
    ...
    it('works for RMLLDES0001a base', function (done) {
      work('incrml-ldes/RMLLDES0001a/base.yaml', 'incrml-ldes/RMLLDES0001a/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001a change', function (done) {
      work('incrml-ldes/RMLLDES0001a/change.yaml', 'incrml-ldes/RMLLDES0001a/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001b base', function (done) {
      work('incrml-ldes/RMLLDES0001b/base.yaml', 'incrml-ldes/RMLLDES0001b/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001b change', function (done) {
      work('incrml-ldes/RMLLDES0001b/change.yaml', 'incrml-ldes/RMLLDES0001b/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001c base', function (done) {
      work('incrml-ldes/RMLLDES0001c/base.yaml', 'incrml-ldes/RMLLDES0001c/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001c change', function (done) {
      work('incrml-ldes/RMLLDES0001c/change.yaml', 'incrml-ldes/RMLLDES0001c/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001d base', function (done) {
      work('incrml-ldes/RMLLDES0001d/base.yaml', 'incrml-ldes/RMLLDES0001d/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001d change', function (done) {
      work('incrml-ldes/RMLLDES0001d/change.yaml', 'incrml-ldes/RMLLDES0001d/change.rml.ttl', done, {includeMetadata: false});
    });

    // test cases e-h generate the same rml, but the test cases use different input...
    it('works for RMLLDES0001e base', function (done) {
      work('incrml-ldes/RMLLDES0001e/base.yaml', 'incrml-ldes/RMLLDES0001e/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001e change', function (done) {
      work('incrml-ldes/RMLLDES0001e/change.yaml', 'incrml-ldes/RMLLDES0001e/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001f base', function (done) {
      work('incrml-ldes/RMLLDES0001f/base.yaml', 'incrml-ldes/RMLLDES0001f/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001f change', function (done) {
      work('incrml-ldes/RMLLDES0001f/change.yaml', 'incrml-ldes/RMLLDES0001f/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001g base', function (done) {
      work('incrml-ldes/RMLLDES0001g/base.yaml', 'incrml-ldes/RMLLDES0001g/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001g change', function (done) {
      work('incrml-ldes/RMLLDES0001g/change.yaml', 'incrml-ldes/RMLLDES0001g/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001h base', function (done) {
      work('incrml-ldes/RMLLDES0001h/base.yaml', 'incrml-ldes/RMLLDES0001h/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001h change', function (done) {
      work('incrml-ldes/RMLLDES0001h/change.yaml', 'incrml-ldes/RMLLDES0001h/change.rml.ttl', done, {includeMetadata: false});
    });

    it('works for RMLLDES0002a base', function (done) {
      work('incrml-ldes/RMLLDES0002a/base.yaml', 'incrml-ldes/RMLLDES0002a/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002a change', function (done) {
      work('incrml-ldes/RMLLDES0002a/change.yaml', 'incrml-ldes/RMLLDES0002a/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002b base', function (done) {
      work('incrml-ldes/RMLLDES0002b/base.yaml', 'incrml-ldes/RMLLDES0002b/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002b change', function (done) {
      work('incrml-ldes/RMLLDES0002b/change.yaml', 'incrml-ldes/RMLLDES0002b/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002c base', function (done) {
      work('incrml-ldes/RMLLDES0002c/base.yaml', 'incrml-ldes/RMLLDES0002c/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002c change', function (done) {
      work('incrml-ldes/RMLLDES0002c/change.yaml', 'incrml-ldes/RMLLDES0002c/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002d base', function (done) {
      work('incrml-ldes/RMLLDES0002d/base.yaml', 'incrml-ldes/RMLLDES0002d/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002d change', function (done) {
      work('incrml-ldes/RMLLDES0002d/change.yaml', 'incrml-ldes/RMLLDES0002d/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002e base', function (done) {
      work('incrml-ldes/RMLLDES0002e/base.yaml', 'incrml-ldes/RMLLDES0002e/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002e change', function (done) {
      work('incrml-ldes/RMLLDES0002e/change.yaml', 'incrml-ldes/RMLLDES0002e/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002f base', function (done) {
      work('incrml-ldes/RMLLDES0002f/base.yaml', 'incrml-ldes/RMLLDES0002f/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002f change', function (done) {
      work('incrml-ldes/RMLLDES0002f/change.yaml', 'incrml-ldes/RMLLDES0002f/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002g base', function (done) {
      work('incrml-ldes/RMLLDES0002g/base.yaml', 'incrml-ldes/RMLLDES0002g/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002g change', function (done) {
      work('incrml-ldes/RMLLDES0002g/change.yaml', 'incrml-ldes/RMLLDES0002g/change.rml.ttl', done, {includeMetadata: false});
    });

    it('works for RMLLDES0003a base', function (done) {
      work('incrml-ldes/RMLLDES0003a/base.yaml', 'incrml-ldes/RMLLDES0003a/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003a change', function (done) {
      work('incrml-ldes/RMLLDES0003a/change.yaml', 'incrml-ldes/RMLLDES0003a/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003b base', function (done) {
      work('incrml-ldes/RMLLDES0003b/base.yaml', 'incrml-ldes/RMLLDES0003b/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003b change', function (done) {
      work('incrml-ldes/RMLLDES0003b/change.yaml', 'incrml-ldes/RMLLDES0003b/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003c base', function (done) {
      work('incrml-ldes/RMLLDES0003c/base.yaml', 'incrml-ldes/RMLLDES0003c/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003c change', function (done) {
      work('incrml-ldes/RMLLDES0003c/change.yaml', 'incrml-ldes/RMLLDES0003c/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003d base', function (done) {
      work('incrml-ldes/RMLLDES0003d/base.yaml', 'incrml-ldes/RMLLDES0003d/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003d change', function (done) {
      work('incrml-ldes/RMLLDES0003d/change.yaml', 'incrml-ldes/RMLLDES0003d/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003e base', function (done) {
      work('incrml-ldes/RMLLDES0003e/base.yaml', 'incrml-ldes/RMLLDES0003e/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003e change', function (done) {
      work('incrml-ldes/RMLLDES0003e/change.yaml', 'incrml-ldes/RMLLDES0003e/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003f base', function (done) {
      work('incrml-ldes/RMLLDES0003f/base.yaml', 'incrml-ldes/RMLLDES0003f/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003f change', function (done) {
      work('incrml-ldes/RMLLDES0003f/change.yaml', 'incrml-ldes/RMLLDES0003f/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003g base', function (done) {
      work('incrml-ldes/RMLLDES0003g/base.yaml', 'incrml-ldes/RMLLDES0003g/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003g change', function (done) {
      work('incrml-ldes/RMLLDES0003g/change.yaml', 'incrml-ldes/RMLLDES0003g/change.rml.ttl', done, {includeMetadata: false});
    });
  });
