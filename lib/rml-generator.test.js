...
describe('YARRRML to RML', function () {
  ...
  describe('IncRML-LDES', () => {
    ...
    // test cases a-d generate the same rml, but the test cases use different input...
    it('works for RMLLDES0001a base', function (done) {
      work('incrml-ldes/RMLLDES0001a/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0001a/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001a change', function (done) {
      work('incrml-ldes/RMLLDES0001a/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0001a/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001b base', function (done) {
      work('incrml-ldes/RMLLDES0001b/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0001b/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001b change', function (done) {
      work('incrml-ldes/RMLLDES0001b/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0001b/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001c base', function (done) {
      work('incrml-ldes/RMLLDES0001c/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0001c/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001c change', function (done) {
      work('incrml-ldes/RMLLDES0001c/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0001c/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001d base', function (done) {
      work('incrml-ldes/RMLLDES0001d/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0001d/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001d change', function (done) {
      work('incrml-ldes/RMLLDES0001d/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0001d/change.rml.ttl', done, {includeMetadata: false});
    });

    // test cases e-h generate the same rml, but the test cases use different input...
    it('works for RMLLDES0001e base', function (done) {
      work('incrml-ldes/RMLLDES0001e/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0001e/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001e change', function (done) {
      work('incrml-ldes/RMLLDES0001e/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0001e/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001f base', function (done) {
      work('incrml-ldes/RMLLDES0001f/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0001f/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001f change', function (done) {
      work('incrml-ldes/RMLLDES0001f/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0001f/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001g base', function (done) {
      work('incrml-ldes/RMLLDES0001g/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0001g/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001g change', function (done) {
      work('incrml-ldes/RMLLDES0001g/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0001g/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001h base', function (done) {
      work('incrml-ldes/RMLLDES0001h/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0001h/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0001h change', function (done) {
      work('incrml-ldes/RMLLDES0001h/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0001h/change.rml.ttl', done, {includeMetadata: false});
    });

    it('works for RMLLDES0002a base', function (done) {
      work('incrml-ldes/RMLLDES0002a/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0002a/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002a change', function (done) {
      work('incrml-ldes/RMLLDES0002a/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0002a/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002b base', function (done) {
      work('incrml-ldes/RMLLDES0002b/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0002b/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002b change', function (done) {
      work('incrml-ldes/RMLLDES0002b/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0002b/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002c base', function (done) {
      work('incrml-ldes/RMLLDES0002c/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0002c/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002c change', function (done) {
      work('incrml-ldes/RMLLDES0002c/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0002c/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002d base', function (done) {
      work('incrml-ldes/RMLLDES0002d/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0002d/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002d change', function (done) {
      work('incrml-ldes/RMLLDES0002d/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0002d/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002e base', function (done) {
      work('incrml-ldes/RMLLDES0002e/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0002e/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002e change', function (done) {
      work('incrml-ldes/RMLLDES0002e/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0002e/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002f base', function (done) {
      work('incrml-ldes/RMLLDES0002f/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0002f/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002f change', function (done) {
      work('incrml-ldes/RMLLDES0002f/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0002f/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002g base', function (done) {
      work('incrml-ldes/RMLLDES0002g/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0002g/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0002g change', function (done) {
      work('incrml-ldes/RMLLDES0002g/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0002g/change.rml.ttl', done, {includeMetadata: false});
    });

    it('works for RMLLDES0003a base', function (done) {
      work('incrml-ldes/RMLLDES0003a/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0003a/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003a change', function (done) {
      work('incrml-ldes/RMLLDES0003a/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0003a/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003b base', function (done) {
      work('incrml-ldes/RMLLDES0003b/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0003b/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003b change', function (done) {
      work('incrml-ldes/RMLLDES0003b/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0003b/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003c base', function (done) {
      work('incrml-ldes/RMLLDES0003c/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0003c/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003c change', function (done) {
      work('incrml-ldes/RMLLDES0003c/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0003c/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003d base', function (done) {
      work('incrml-ldes/RMLLDES0003d/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0003d/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003d change', function (done) {
      work('incrml-ldes/RMLLDES0003d/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0003d/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003e base', function (done) {
      work('incrml-ldes/RMLLDES0003e/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0003e/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003e change', function (done) {
      work('incrml-ldes/RMLLDES0003e/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0003e/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003f base', function (done) {
      work('incrml-ldes/RMLLDES0003f/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0003f/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003f change', function (done) {
      work('incrml-ldes/RMLLDES0003f/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0003f/change.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003g base', function (done) {
      work('incrml-ldes/RMLLDES0003g/base.yarrrml.yaml', 'incrml-ldes/RMLLDES0003g/base.rml.ttl', done, {includeMetadata: false});
    });
    it('works for RMLLDES0003g change', function (done) {
      work('incrml-ldes/RMLLDES0003g/change.yarrrml.yaml', 'incrml-ldes/RMLLDES0003g/change.rml.ttl', done, {includeMetadata: false});
    });
  });
