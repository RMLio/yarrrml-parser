...
describe('YARRRML to RML', function () {
  ...
  it('function crossConcatSequence', function (done) {
    work('function-crossconcat-sequence/mapping.yaml', 'function-crossconcat-sequence/mapping.rml.ttl', done, {includeMetadata: false});
  });
  ...
  describe('logical target', () => {
    describe('single target', () => {
      it('local file', function (done) {
        work('target-single/local-file/mapping.yarrrml.yml', 'target-single/local-file/mapping.rml.ttl', done, {includeMetadata: false});
      });
      it('local file shortcut 1', function (done) {
        work('target-single/local-file/mapping-shortcut1.yarrrml.yml', 'target-single/local-file/mapping-shortcut1.rml.ttl', done, {includeMetadata: false});
      });
      it('local file shortcut 2', function (done) {
        work('target-single/local-file/mapping-shortcut2.yarrrml.yml', 'target-single/local-file/mapping-shortcut2.rml.ttl', done, {includeMetadata: false});
      });
      it('local file dynamic', function (done) {
        work('target-single/local-file/mapping-dynamic.yarrrml.yml', 'target-single/local-file/mapping-dynamic.rml.ttl', done, {includeMetadata: false});
      });
      it('local file dynamic shortcut', function (done) {
        work('target-single/local-file/mapping-dynamic-shortcut1.yarrrml.yml', 'target-single/local-file/mapping-dynamic.rml.ttl', done, {includeMetadata: false});
      });
      it('local file VoID datadump', function (done) {
        work('target-single/void/mapping.yarrrml.yml', 'target-single/void/mapping.rml.ttl', done, {includeMetadata: false});
      });
      it('local file VoID datadump dynamic', function (done) {
        work('target-single/void/mapping-dynamic.yarrrml.yml', 'target-single/void/mapping-dynamic.rml.ttl', done, {includeMetadata: false});
      });
      it('local DCAT datadump', function (done) {
        work('target-single/dcat/mapping.yarrrml.yml', 'target-single/dcat/mapping.rml.ttl', done, {includeMetadata: false});
      });
      it('local dcat shortcut 1', function (done) {
        work('target-single/dcat/mapping-shortcut1.yarrrml.yml', 'target-single/dcat/mapping-shortcut1.rml.ttl', done, {includeMetadata: false});
      });
      it('local dcat shortcut 2', function (done) {
        work('target-single/dcat/mapping-shortcut2.yarrrml.yml', 'target-single/dcat/mapping-shortcut2.rml.ttl', done, {includeMetadata: false});
      });
      it('local file DCAT datadump dynamic', function (done) {
        work('target-single/dcat/mapping-dynamic.yarrrml.yml', 'target-single/dcat/mapping-dynamic.rml.ttl', done, {includeMetadata: false});
      });
      it('SPARQL endpoint', function (done) {
        work('target-single/sparql-update/mapping.yarrrml.yml', 'target-single/sparql-update/mapping.rml.ttl', done, {includeMetadata: false});
      });
      it('SPARQL endpoint shortcut', function (done) {
        work('target-single/sparql-update/mapping-shortcut.yarrrml.yml', 'target-single/sparql-update/mapping.rml.ttl', done, {includeMetadata: false});
      });
      it('SPARQL endpoint - SD', function (done) {
        work('target-single/sparql-update/mapping-sd.yarrrml.yml', 'target-single/sparql-update/mapping.rml.ttl', done, {includeMetadata: false});
      });
      it('SPARQL endpoint shortcut - SD', function (done) {
        work('target-single/sparql-update/mapping-shortcut-sd.yarrrml.yml', 'target-single/sparql-update/mapping.rml.ttl', done, {includeMetadata: false});
      });
    });
  ...
  describe('subject blank node', function () {
    it('no template or constant', function (done) {
      work('subject-blank-node/mapping.yarrrml', 'subject-blank-node/mapping.rml.ttl', done, {includeMetadata: false});
    });

    it('template', function (done) {
      work('subject-blank-node/template/mapping.yarrrml', 'subject-blank-node/template/mapping.rml.ttl', done, {includeMetadata: false});
    });

    it('constant', function (done) {
      work('subject-blank-node/constant/mapping.yarrrml', 'subject-blank-node/constant/mapping.rml.ttl', done, {includeMetadata: false});
    });
  });
